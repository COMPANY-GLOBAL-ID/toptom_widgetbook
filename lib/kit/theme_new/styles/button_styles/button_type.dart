...
enum ButtonType {
  ...
  Color background(ButtonColor color, BuildContext context) {
    ...
    return switch (this) {
      ...
      ButtonType.outlined => colorTheme.scheme.white.withOpacity(0),
      ButtonType.ghost => switch (color) {
          ...
          ButtonColor.white => colorTheme.scheme.white.withOpacity(0.2),
        },
      ButtonType.defaultButton => colorTheme.scheme.white.withOpacity(0),
    };
  }
  ...
  Color backgroundPressed(ButtonColor color, BuildContext context) {
    ...
    return switch (this) {
      ...
      ButtonType.ghost => switch (color) {
          ...
          ButtonColor.white => colorTheme.scheme.white.withOpacity(0.4),
        },
  ...
  Color foreground(ButtonColor color, BuildContext context) {
    ...
    return switch (this) {
      ButtonType.primary => switch (color) {
          ...
          ButtonColor.white => colorTheme.scheme.white,
        },
